...
from open_webui.internal.db import ScopedSession, engine, get_async_session, validate_all_schemas, SchemaValidationError
...
"""
        ...
        # Fallback for Windows terminals that don't support Unicode box-drawing characters
        print(
            rf"""
OPEN WEBUI
...
app.state.config.SHAREPOINT_IMPORT_MAX_TOTAL_SIZE_MB = SHAREPOINT_IMPORT_MAX_TOTAL_SIZE_MB
...
app.state.config.RAG_NATIVE_FC_FORCE_RETRIEVAL = RAG_NATIVE_FC_FORCE_RETRIEVAL
