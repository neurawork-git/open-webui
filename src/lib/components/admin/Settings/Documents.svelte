	...
	{#if RAGConfig}
		<div class="flex-1 min-h-0 overflow-y-auto scrollbar-hover pr-1.5">
			...
			<AdminSettingSection title={$i18n.t('Retrieval')}>
				<!-- FORK: deterministic KB injection on native function calling -->
				<AdminSettingRow
					label={$i18n.t('Force knowledge retrieval on native tool calling')}
					description={$i18n.t(
				...
				>
					<Switch
						bind:state={RAGConfig.RAG_NATIVE_FC_FORCE_RETRIEVAL}
						ariaLabelledbyId={labelId}
					/>
				</AdminSettingRow>
